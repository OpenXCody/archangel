...
export default function Map() {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      // REDUCED at continental zoom (z3-5) to prevent white-out blob per CEO requirement.
      // Keeps luminous white dots, NO blue numbered cluster badges.
      currentMap.addLayer({
        ...
        paint: {
          ...
          'circle-radius': [
            ...
            4, ['case', ['boolean', ['feature-state', 'selected'], false], 6, ['boolean', ['feature-state', 'hover'], false], 5, 3],
      ...
      // REDUCED at continental zoom (z3-5) to prevent white-out blob per CEO requirement.
      // Smaller, more transparent dots at low zoom, ramping up visibility at z6+.
      currentMap.addLayer({
        id: 'factory-points',
        type: 'circle',
        source: 'factories',
  ...
  // filter forces pins on. REDUCED at continental zoom to prevent white-out blob.
